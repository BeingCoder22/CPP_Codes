...
int main()
{
    ...
    {
        /* code */ 
        printf("1.Display 2.Append 3.Insert 4.Delete 5.LinearSearch 6.BinarySearch\n");
        printf("7.Get 8.Set 9.Max 10.Min 11.Sum 12.Avg\n");
        printf("13.Reverse2 14.LeftShift 15.RightShift\n");
        printf("16.InsertSort 17.IsSorted 18.Rearrange \n");
        printf("19.Merge 20.Union 21.Intersection 22.Differenc\n");
        printf("23. Exit\n \n");
        ...
        case 1: Display(arr);
                break;
        case 2: printf("Enter a number to add in list\n");
                scanf("%d",&n);
                /* Performing Append operation which value will be added as last element of an array */
                Append(&arr,13);
                break;
        case 3: printf("Enter index and element to insert in list\n");
                scanf("%d %d",&i, &n);
                /* Performing Insert operation which value will be added in given index of an array */
                Insert(&arr,i,n);
                break;
        case 4: printf("Enter index no. to delete an element\n");
                scanf("%d", &i);
                /* Calling Delete function to delete an element */
                Delete(&arr,i);
                break;
        case 5: printf("Enter Element to find in list\n");
                scanf("%d",&n);
                /* Calling LinearSearch function to find the element at which index of an array */
                printf("Element Found at index: %d\n",LinearSearch(&arr, n));
                break;
        case 6: printf("Enter Element to find in list\n");
                scanf("%d",&n);
                /* Calling BinarySearch function to find the element at which index of an array */
                printf("Element Found at index: %d\n",BinarySearch(arr, n));
                /* Calling BinarySearch function to find the element at which index of an array */
                // printf("Element Found at index: %d\n",RBinarySearch(arr.A,0,arr.length,n));
                break;
        case 7: printf("Enter index to find element in a list\n");
                scanf("%d",&i);      
                /* Calling get function to get the index of given element */
                printf("Element Found at index: %d\n", Get(arr, i));
                break; 
        case 8: printf("Enter index and element to Set/Replace in list\n");
                scanf("%d %d",&i, &n);
                /* Calling Set function */
                Set(&arr,i,n);
                break;
        case 9: /* Calling Max Function and get the Max value in an Array */
                printf("Maximum value is: %d\n", Max(arr));
                break;
        case 10: /* Calling Min Function and get the Minimum value in an Array */
                printf("Minimum value is: %d\n", Min(arr));
                break;
        case 11: /* Calling Sum Function and get the sum of all elements in an Array */
                printf("Sum of all Array's element is: %d\n", Sum(arr));
                break;
        case 12: /* Calling Avg Function and get the Average value in an Array */
                printf("Average of all Array's element is: %2.2f\n", Avg(arr));
                break;
        case 13: /* Calling Reverse function to reverse the array */
                Reverse(&arr);
                break;
        case 14: printf("How many times you want to shift left\n");
                 scanf("%d",&n);
                 /* Calling LeftShift function to left shift the element of Array */
                 LeftShift(&arr,n);
                break;
        case 15: printf("How many times you want to shift right\n");
                 scanf("%d",&n);
                 /* Calling RighShift function to Right shift the element of Array */
                 RightShift(&arr,n);
                break;
        case 16: printf("Enter an element \n");
                 scanf("%d",&n);
                 /* Calling InsertSort function to insert an element to its sorted position */
                 InsertSort(&arr, n);
                break;
        case 17: if(IsSorted(arr))
                 {
                     printf("Array is sorted\n");
                 }   
                break;
        case 18: /* Calling Rearrange function to arrangre -ve/+ve value aside  */
                 Rearrange(&arr);  
                break;
        case 19: Fun_Merge();
                break;
        case 20: Fun_Union();
                break;
        case 21: Fun_Intersection();
                break;
        case 22: Fun_Differenc();
                break;
        default:
            break;
        }
